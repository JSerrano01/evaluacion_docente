...
$pdf->Cell(0, 8, utf8_decode('CASO 2: DOCENTE CÁTEDRA - SIN CÁTEDRA'), 1, 1, 'C', true);
$pdf->Ln(1);
...
$dominio_disc = $funcion->promedio_valores_preguntas($data_aecatedra[0], 1, 8, 'aecatedra');
...
//Definir el alto máximo de la tabla
$maxHeight = 250;
...
$tableHeight = count($data_estudiantes1) * 6;

//Agregar una nueva página si la tabla excede el espacio disponible en la página actual
if ($currentHeight + $tableHeight > $maxHeight) {
    $pdf->AddPage();
}
