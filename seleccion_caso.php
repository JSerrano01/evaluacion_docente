...
?>
    <form id="myForm" action="/evaluacion_docente/generarpdf_caso3.php" method="post">
    ...
    if (mysqli_num_rows($resultado) > 0) {
        // el número de documento se encontró en ae_docente_catedra para Docente Ocasional, enviar POST a archivo1.php
    ?>
        <form id="myForm" action="/evaluacion_docente/generarpdf_caso2.php" method="post">
            <input type="hidden" name="documento" value="<?php echo $documento ?>">
        </form>
        <script>
            // Obtener el formulario
        ...
        if (mysqli_num_rows($resultado) > 0) {
            // el número de documento se encontró en ae_docente_catedra para Docente Ocasional, enviar POST a archivo1.php
        ?>
            <form id="myForm" action="/evaluacion_docente/generarpdf_caso1.php" method="post">
                <input type="hidden" name="documento" value="<?php echo $documento ?>">
            </form>
            <script>
                // Obtener el formulario
