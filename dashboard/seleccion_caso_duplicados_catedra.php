...
?>
    <form id="myForm" action="/evaluacion_docente/dashboard/generarpdf_caso3_catedra_duplicados.php" method="post">
    ...
    if (mysqli_num_rows($resultado) > 0) {
        // el número de documento se encontró en ae_docente_catedra para Docente Ocasional, enviar POST a archivo1.php
    ?>
        <form id="myForm" action="/evaluacion_docente/dashboard/generarpdf_caso2_catedra_duplicados.php" method="post">
            <input type="hidden" name="documento" value="<?php echo $documento ?>">
        </form>
        <script>
            // Obtener el formulario
        ...
        if (mysqli_num_rows($resultado) > 0) {
            // el número de documento se encontró en ae_docente_catedra para Docente Ocasional, enviar POST a archivo1.php
        ?>
            <form id="myForm" action="/evaluacion_docente/dashboard/generarpdf_caso1_catedra_duplicados.php" method="post">
                <input type="hidden" name="documento" value="<?php echo $documento ?>">
            </form>
            <script>
                // Obtener el formulario
