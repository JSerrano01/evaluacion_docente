...
<<<<<<< HEAD
    ...
    $consulta = "SELECT * FROM informes_finales";
...
<<<<<<< HEAD
        ...
        <button class="btn btn-primary btn-sm btn-default btn-flat border-primary" onclick="window.location.href='actualizar_informes_finales.php'">ACTUALIZAR</button>
        ...
        <form action="http://127.0.0.1:5000/descargar_informe_final"  method="get">
            <br>
            <button class="btn btn-primary btn-sm btn-default btn-flat border-primary" type="submit">DESCARGAR EXCEL</button>
        </form>
